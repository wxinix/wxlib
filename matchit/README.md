# match(it): A lightweight header-only pattern-matching library for C++20 with macro-free APIs.

![match(it).cpp](./doc/matchit.cpp.svg)
...
int32_t static_cast_as(Num const& input)
{
    using namespace matchit;
    return match(input)(
